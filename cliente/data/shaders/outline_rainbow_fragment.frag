...
void main()
{
    ...
    vec2 texel = vec2(5.6/512.0, 3.0/512.0);
    ...
    vec4 col;
	col.r = sin(.6 * (v_TexCoord.y * 150.0) + u_Time * 11. + 0.) * 0.3 + 0.5;
	//col.g = sin(.6 * (v_TexCoord.y * 150.0) + u_Time * 10. + 2.) * 0.5 + 0.5;
	//col.b = sin(.6 * (v_TexCoord.y * 150.0)  + u_Time * 10. + 4.) * 0.5 + 0.5;
    col.a = 1.0;
