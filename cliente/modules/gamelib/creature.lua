...
function getIconImagePath(iconId)
	...
	elseif iconId == NpcIconDailyCatch then
		path = "/images/game/npcicons/icon_daily_catch"
	elseif iconId == NpcIconDailyKill then
		path = "/images/game/npcicons/icon_daily_kill"
	elseif iconId == NpcIconDailyCatchKill then
		path = "/images/game/npcicons/icon_daily_catch_kill"
	end
...
function Creature:onShieldChange(shieldId)
	...
	if imagePath and shieldId ~= ShieldSummon and shieldId ~= ShieldOtherSummon then
...
function Creature:isSummon()
	return self:getShield() == ShieldSummon
end

function Creature:isOtherSummon()
	return self:getShield() == ShieldOtherSummon
end
