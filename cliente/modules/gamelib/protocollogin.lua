...
function ProtocolLogin:parseCharacterList(msg)
  ...
  if g_game.getProtocolVersion() > 1010 then
    ...
    for i=1, charactersCount do
	  ...
	  character.looktype	 = msg:getU32()
	  character.lookbody	 = msg:getU32()
	  character.lookfeet	 = msg:getU32()
	  character.lookhead 	 = msg:getU32()
	  character.looklegs	 = msg:getU32()
	  character.lookaddons	 = msg:getU32()
	  character.pokemons 	 = msg:getString()
