	...
	if not g_game.getFeature(GameAdditionalVipInfo) then
		...
		if tmpVipInfo then
			if tmpVipInfo.iconId then
				label:setIconColor(tocolor(tmpVipInfo.iconId ~= 0 and iconsConfig.color[tmpVipInfo.iconColorId] or "white"))
				label:setIconClip(torect((iconsConfig.rect[tmpVipInfo.iconId] or "0") .. " 0 25 25"))
				label:setIconOffset(iconsConfig.offset[tmpVipInfo.iconId] or "0 0")
				label:setTextOffset((tmpVipInfo.iconId ~= 0 and "23" or "0") .. " 4")

				label.iconColorId = tmpVipInfo.iconColorId
		...
		label:setIconColor(tocolor(iconId ~= 0 and iconsConfig.color[iconColorId] or "white"))
		label:setIconOffset(iconsConfig.offset[tmpVipInfo.iconId] or "0 0")
		label:setIconClip(torect(iconsConfig.rect[iconId] .. " 0 25 25"))
		label:setTextOffset((iconId ~= 0 and "23" or "0") .. " 4")

		label.iconColorId = iconColorId
		label.iconId = iconId
